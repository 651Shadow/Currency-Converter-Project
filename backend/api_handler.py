...
def get_currency_data():
    ...
    try:
        ...
        json.dump(dict(response.json()), open("currency.json", "w+"), indent=4)
        ...
        if os.path.exists("currency.json"):
            ...
            print(
                "No cached currency file found. Please check your internet connection."
            )
            exit(5)
            return False
    ...
    try:
        ...
        cleaned_data = {"conversion_rates": data.get("conversion_rates", {})}
